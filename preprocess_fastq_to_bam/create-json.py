...
def create_data():
    ...
    for name,path in zip(samples_names,samples):
        ...
        "PreProcessingForVariantDiscovery_GATK4.ref_dict": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.dict",
        "PreProcessingForVariantDiscovery_GATK4.ref_fasta": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta",
        "PreProcessingForVariantDiscovery_GATK4.ref_fasta_index": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta.fai",
        "PreProcessingForVariantDiscovery_GATK4.ref_alt": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta.64.alt",
        "PreProcessingForVariantDiscovery_GATK4.ref_sa": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta.64.sa",
        "PreProcessingForVariantDiscovery_GATK4.ref_amb": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta.64.amb",
        "PreProcessingForVariantDiscovery_GATK4.ref_bwt": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta.64.bwt",
        "PreProcessingForVariantDiscovery_GATK4.ref_ann": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta.64.ann",
        "PreProcessingForVariantDiscovery_GATK4.ref_pac": "/groups/cgsd/alexandre/GATK_workflows/src/hg38/Homo_sapiens_assembly38.fasta.64.pac",
